			...
			<div className="relative z-10 max-w-7xl mx-auto px-6 py-24">
				...
				>
					...
					<p className="font-body text-lg text-white/80 leading-relaxed max-w-xl text-balance mb-32">
						We operate safehouses in the Philippines for girls who are survivors
						of sexual abuse and sex trafficking. Every child deserves safety,
						healing, and a future full of hope. With your contribution, we can
