      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid md:grid-cols-3 gap-10">
          <div className="md:col-span-1">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="font-heading text-lg font-semibold text-white">Keeper</span>
            </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <a href="mailto:info@keeper.org" className="flex items-center gap-2 text-sm hover:text-white transition-colors">
              ...
              <div className="flex items-center gap-2 text-sm">
                <MapPin className="h-4 w-4 text-accent" /> Arlington, VA 22201
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <a href="#" className="block text-sm hover:text-white transition-colors">Cookie Consent</a>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-white/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="font-body text-xs text-white/40">
            © {new Date().getFullYear()} Keeper. All rights reserved. 501(c)(3) Tax-Exempt Organization.
          </p>
